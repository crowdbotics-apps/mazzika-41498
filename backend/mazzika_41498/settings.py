"""
Django settings for mazzika_41498 project.
...
ROOT_URLCONF = 'mazzika_41498.urls'
...
WSGI_APPLICATION = 'mazzika_41498.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mazzika_41498 API",
    "DESCRIPTION": "API documentation for mazzika_41498 App",
    "VERSION": "v1",
}
